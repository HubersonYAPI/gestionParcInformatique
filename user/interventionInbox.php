              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="interventionDetail.php">Gustave Flaubert</a></td>
                    <td class="mailbox-subject"><b>Résolu</b> - Trying to find a solution to this problem...
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-star"><a href="#"><i class="fas fa-star-o text-warning"></i></a></td>
                    <td class="mailbox-name"><a href="interventionDetail.php">Gustave Flaubert</a></td>
                    <td class="mailbox-subject"><b>En attente</b> - Trying to find a solution to this problem...
                    </td>
                    <td class="mailbox-attachment"><i class="fas fa-paperclip"></i></td>
