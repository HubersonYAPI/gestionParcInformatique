...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="userProfile.php" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="userProfile.php" class="d-block">Gustave Flaubert</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="ordinateur.php" class="nav-link">
              ...
              <li class="nav-item">
                <a href="imprimante.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Imprimantes</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="cartouche.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="interventionNew.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Composer</p>
                </a>
              </li>
